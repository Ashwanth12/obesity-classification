...
Array_Ans[5] = d3[st.selectbox('How much water do you drink daily?',
                               ("Less than a liter", "One or two liters", "More than two liters"))]

d4 = {"0 to 1 day": 3, "1 or 2 days": 2, "2 or 4 days": 1, "More than 4": 0}
Array_Ans[6] = d4[
    st.selectbox('How often do you exercise?', ("0 to 1 day", "1 or 2 days", "2 or 4 days", "More than 4"))]

d5 = {"0 to 2 hours": 2, "3 to 5 hours": 1, "More than 5": 0}
Array_Ans[7] = d5[
    st.selectbox('Hours spent using electronic devices?', ("0 to 2 hours", "3 to 5 hours", "More than 5"))]
...
Array_Ans[10] = d8[st.selectbox('From the above, choose your transportation method:',
